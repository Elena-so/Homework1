...
class TodoList extends React.Component {
    ...
    render() {
        ...
        const { addNew, changeFilter, changeStatus,deleteChangeStatus } = this.props.actions
        ...
        return (
            <div className="todolist">
                ...
                <FilteredList items={filtedList} changeStatus={changeStatus} deleteChangeStatus={deleteChangeStatus} />
                {
